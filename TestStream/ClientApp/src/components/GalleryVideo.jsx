            ...
            return (
                ...
                <div className="d-flex justify-content-around">
                        ...
                        <div className="card cardBg">
                                    <video controls src={`${this.props.customer.festivalFile.fileURL}`} style={{ height: "270px", width: "auto", borderRadius:"26px 26px 0 0"}} className="card-img-top" alt='عکس مربوطه'/>
